...
const RestaurantCard = (props) => {
    ...
    return (
//     <div data-testid="resCard" className="m-4 mt-6 p-4 w-[230px] rounded-lg bg-gray-100 hover:bg-gray-300">
//     <img className="res-logo rounded-lg" src={CDN_URL + cloudinaryImageId} alt="res-logo" />
//     <div className="mt-4">
//         <h3 className="font-bold text-sm">{name}</h3>
//         <h4 className="text-sm text-gray-600">{trucateCuisines(cuisines)}</h4>
...
//     </div>
// </div>
        <div data-testid="resCard" className="m-4 mt-6 p-4 w-[230px] h-[350px] rounded-lg bg-gray-100 hover:bg-gray-300 flex flex-col justify-between">
